...
class OffboardControl:
    ...
    def __init__(self):
        ...
        self.pose_sub2 = rospy.Subscriber('uav0/mavros/local_position/pose', PoseStamped, callback=self.pose_callback2)
        ...
        self.vel_pub2 = rospy.Publisher('uav0/mavros/setpoint_raw/local', PositionTarget, queue_size=10)
        self.controller()

    def pose_callback1(self, msg):
        self.curr_pose1_1 = msg
        self.curr_pose1.pose.position.x = self.curr_pose1_1.pose.position.x - 12
    ...
    def pose_callback2(self, msg):
        ...
        self.curr_pose2.pose.position.x = self.curr_pose2_1.pose.position.x - 6
    ...
    def hover2(self):
        ...
        while self.mode2 == "HOVER" and not rospy.is_shutdown():
            ...
            curr_x = self.curr_pose2.pose.position.x + 6
    ...
    def go_straight(self, step):
        ...
        while self.mode2 == "Go_straight" and not rospy.is_shutdown():
            ...
            des_y = loc[waypoint_index][1]
            des_z = loc[waypoint_index][2]
            self.des_pose.pose.position.x = des_x + 6
            self.des_pose.pose.position.y = des_y
            self.des_pose.pose.position.z = des_z
            self.des_pose.pose.orientation.x = 0
            self.des_pose.pose.orientation.y = 0
